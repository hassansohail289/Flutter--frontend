...
class _LoginScreenState extends State<LoginScreen> {
              ...
              child: Column(
                children: [
                  ...
                  if (!_isLogin) ...[
                    Row(
                      children: [
                        Expanded(child: _inputField(_firstNameController, "First Name", Icons.person_outline, false, screenWidth, autofillHints: [AutofillHints.givenName])),
                        SizedBox(width: screenWidth * 0.03),
                        Expanded(child: _inputField(_lastNameController, "Last Name", Icons.person_outline, false, screenWidth, autofillHints: [AutofillHints.familyName])),
                      ],
                    ),
                    SizedBox(height: screenHeight * 0.018),
                  ],

                  _inputField(_emailController, "Email address", Icons.email_outlined, false, screenWidth, autofillHints: [AutofillHints.email]),
                  SizedBox(height: screenHeight * 0.018),
                  _inputField(_passwordController, "Password", Icons.lock_outline, true, screenWidth, autofillHints: [AutofillHints.password]),
  ...
  Widget _inputField(TextEditingController ctrl, String hint, IconData icon, bool obs, double sw, {Iterable<String>? autofillHints}) {
    return Container(
